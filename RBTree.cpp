...
void RBTree<T>::print(RBTNode<T>* node)const {
	...
	if (node->parent == NULL) {
		if (node->color == 1) {
			...
			cout << node->key << "(" << "red" << ") is root" << endl;
		}
		else {
			cout << node->key << "(" << "black" << ") is root" << endl;
		}
	...
	{
		if (node->color == 1) {
			cout << node->key << "(" << "red" << ") is " << node->parent->key << "'s " << "left child" << endl;
		}
		else {
			cout << node->key << "(" << "black" << ") is " << node->parent->key << "'s " << "left child" << endl;
		}
	...
	{
		if (node->color == 1) {
			cout << node->key << "(" << "red" << ") is " << node->parent->key << "'s " << "right child" << endl;
		}
		else {
			cout << node->key << "(" << "black" << ") is " << node->parent->key << "'s " << "right child" << endl;
		}
